...
const AboutMeText = () => {
  return (
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center">
      ...
      <p>
        I’m Md Mehedi Hasan, a web developer instructor with a passion for teaching
        ...
        also work with back-end development. Outside of coding, I enjoy continuous learning and
